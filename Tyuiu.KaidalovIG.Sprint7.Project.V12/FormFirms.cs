...
{
    public partial class FormFirma_KIG : Form
    {
        ...
        public FormFirma_KIG()
        {
            InitializeComponent();
            dataGridViewFirms_KIG.DataSource = ReadCSVFile(@"../../Resoors/InfoAboutStore.csv");
        }

        private void dataGridViewFirms_KIG_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
